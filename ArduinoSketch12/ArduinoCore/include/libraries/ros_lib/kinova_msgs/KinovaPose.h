#ifndef _ROS_kinova_msgs_KinovaPose_h
#define _ROS_kinova_msgs_KinovaPose_h
...
namespace kinova_msgs
{
  ...
  class KinovaPose : public ros::Msg
  {
    public:
      float X;
      float Y;
    ...
    const char * getType(){ return "kinova_msgs/KinovaPose"; };
    const char * getMD5(){ return "e831d993faea563f6fe69d7db9b384c9"; };

...
static const char STOP[] = "kinova_msgs/Stop";
  ...
  class StopResponse : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      memcpy(outbuffer + offset, &length_stop_result, sizeof(uint32_t));
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      memcpy(&length_stop_result, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
    ...
    const char * getType(){ return STOP; };
    const char * getMD5(){ return "585dc4164508d473dff8f8b67a05d2ad"; };

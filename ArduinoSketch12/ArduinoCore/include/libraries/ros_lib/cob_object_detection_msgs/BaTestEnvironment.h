...
static const char BATESTENVIRONMENT[] = "cob_object_detection_msgs/BaTestEnvironment";
  ...
  {
    public:
      int32_t number_points;
      float frame_view_number;
      float cone_points_per_plane;
      float limit_error_matching;
      float ba_kernel_param;
      int32_t ba_num_iter;
      float ba_initial_mu;
      float ba_final_mu_factor;
      float ba_tau;
      float angle_sigma_degree;
      float translate_sigma_m;
      float obs_point_sigma_m;
      float world_point_sigma_m;
